...
using Reign.Physics2D.Common.Decomposition.CDT;
using Reign.Physics2D.Common.Decomposition.CDT.Delaunay;
using Reign.Physics2D.Common.Decomposition.CDT.Delaunay.Sweep;
using Reign.Physics2D.Common.Decomposition.CDT.Polygon;
...
namespace Reign.Physics2D.Common.Decomposition
{
    /// <summary>
